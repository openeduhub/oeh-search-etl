...
class ChemieLernprogrammeSpider(LernprogrammeSpiderBase, CrawlSpider):
    ...
    static_values = {
        ...
        "skos": {
            ...
            "discipline": ["http://w3id.org/openeduhub/vocabs/discipline/100"],
            "intendedEndUserRole": [
    ...
    start_urls = [
        "https://raw.githubusercontent.com/jakjkga/chemie-lernprogramme/master/00_metadaten/chemie-lernprogramme_metadaten.csv"
    ]
    ...
    exercises = {
        ...
        "get_url": (
            lambda row: "https://chemie-lernprogramme.de/daten/ueb/ueb_{}.pdf".format(
                re.search(
                    "^https://chemie-lernprogramme.de/daten/programme/js/(.*?)(?:[-_]online)?(?:/|/index.html|.html)$",
                    row["url"],
                ).group(1)
            )
        ),
