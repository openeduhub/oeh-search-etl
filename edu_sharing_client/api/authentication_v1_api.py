...
class AUTHENTICATIONV1Api(object):
    ...
    def authenticate(self, user_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.authenticate(user_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str user_id: User Id (required)
        :param UserProfileAppAuth body: User Profile
        ...
        if kwargs.get('async_req'):
            return self.authenticate_with_http_info(user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.authenticate_with_http_info(user_id, **kwargs)  # noqa: E501
            return data

    def authenticate_with_http_info(self, user_id, **kwargs):  # noqa: E501
        """authenticate user of an registered application.  # noqa: E501

        headers must be set: X-Edu-App-Id, X-Edu-App-Sig, X-Edu-App-Signed, X-Edu-App-Ts  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.authenticate_with_http_info(user_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('user_id' not in params or
            ...
            raise ValueError("Missing the required parameter `user_id` when calling `authenticate`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/authentication/v1/appauth/{userId}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
