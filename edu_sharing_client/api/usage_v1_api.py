...
class USAGEV1Api(object):
    ...
    def set_usage(self, body, repository, **kwargs):  # noqa: E501
        """Set a usage for a node. app signature headers and authenticated user required.  # noqa: E501

        headers must be set: X-Edu-App-Id, X-Edu-App-Sig, X-Edu-App-Signed, X-Edu-App-Ts  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_usage(body, repository, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Usage body:  usage date (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.set_usage_with_http_info(body, repository, **kwargs)  # noqa: E501
        else:
            (data) = self.set_usage_with_http_info(body, repository, **kwargs)  # noqa: E501
            return data

    def set_usage_with_http_info(self, body, repository, **kwargs):  # noqa: E501
        """Set a usage for a node. app signature headers and authenticated user required.  # noqa: E501

        headers must be set: X-Edu-App-Id, X-Edu-App-Sig, X-Edu-App-Signed, X-Edu-App-Ts  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_usage_with_http_info(body, repository, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `set_usage`")  # noqa: E501
        # verify the required parameter 'repository' is set
        if ('repository' not in params or
                params['repository'] is None):
            raise ValueError("Missing the required parameter `repository` when calling `set_usage`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/usage/v1/usages/repository/{repositoryId}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
