...
java -jar openapi-generator-cli.jar generate -g python -o z_api --skip-validate-spec -i https://ai-prompt-service.staging.openeduhub.net/v3/api-docs --package-name z_api
cd z_api
