...
class Profile:
    ...
    attribute_map: Any = ...
    discriminator: Any = ...
    def __init__(self, group_email: Optional[Any] = ..., mediacenter: Optional[Any] = ..., display_name: Optional[Any] = ..., group_type: Optional[Any] = ..., scope_type: Optional[Any] = ...) -> None: ...
    @property
    ...
    @mediacenter.setter
    def mediacenter(self, mediacenter: Any) -> None: ...
    @property
