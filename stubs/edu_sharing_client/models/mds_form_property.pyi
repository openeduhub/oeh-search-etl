...
class MdsFormProperty:
    swagger_types: Any = ...
    attribute_map: Any = ...
    discriminator: Any = ...
    def __init__(self, name: Optional[Any] = ..., label: Optional[Any] = ..., label_hint: Optional[Any] = ..., form_height: Optional[Any] = ..., form_length: Optional[Any] = ..., widget: Optional[Any] = ..., widget_title: Optional[Any] = ..., copy_from: Optional[Any] = ..., validators: Optional[Any] = ..., parameters: Optional[Any] = ..., values: Optional[Any] = ..., default_values: Optional[Any] = ..., multiple: bool = ..., place_holder: Optional[Any] = ..., style_name: Optional[Any] = ..., style_name_label: Optional[Any] = ..., type: Optional[Any] = ...) -> None: ...
    @property
    def name(self): ...
    @name.setter
