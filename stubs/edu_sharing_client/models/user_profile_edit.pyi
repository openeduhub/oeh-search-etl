...
class UserProfileEdit:
    ...
    attribute_map: Any = ...
    discriminator: Any = ...
    def __init__(self, primary_affiliation: Optional[Any] = ..., skills: Optional[Any] = ..., types: Optional[Any] = ..., size_quota: Optional[Any] = ..., first_name: Optional[Any] = ..., last_name: Optional[Any] = ..., email: Optional[Any] = ..., avatar: Optional[Any] = ..., about: Optional[Any] = ...) -> None: ...
    @property
