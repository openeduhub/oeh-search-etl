...
class CollectionReference:
    ...
    attribute_map: Any = ...
    discriminator: Any = ...
    def __init__(self, remote: Optional[Any] = ..., content: Optional[Any] = ..., license: Optional[Any] = ..., is_directory: bool = ..., comment_count: Optional[Any] = ..., rating: Optional[Any] = ..., access_original: Optional[Any] = ..., ref: Optional[Any] = ..., parent: Optional[Any] = ..., type: Optional[Any] = ..., aspects: Optional[Any] = ..., name: Optional[Any] = ..., title: Optional[Any] = ..., metadataset: Optional[Any] = ..., repository_type: Optional[Any] = ..., created_at: Optional[Any] = ..., created_by: Optional[Any] = ..., modified_at: Optional[Any] = ..., modified_by: Optional[Any] = ..., access: Optional[Any] = ..., download_url: Optional[Any] = ..., properties: Optional[Any] = ..., mimetype: Optional[Any] = ..., mediatype: Optional[Any] = ..., size: Optional[Any] = ..., preview: Optional[Any] = ..., icon_url: Optional[Any] = ..., collection: Optional[Any] = ..., owner: Optional[Any] = ..., original_id: Optional[Any] = ...) -> None: ...
    @property
    def remote(self): ...
    @remote.setter
    ...
    def access_original(self, access_original: Any) -> None: ...
    @property
    def ref(self): ...
    @ref.setter
    ...
    @original_id.setter
    def original_id(self, original_id: Any) -> None: ...
    def to_dict(self): ...
    def to_str(self): ...
