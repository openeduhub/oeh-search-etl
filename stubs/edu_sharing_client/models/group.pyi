...
class Group:
    ...
    attribute_map: Any = ...
    discriminator: Any = ...
    def __init__(self, ref: Optional[Any] = ..., editable: bool = ..., authority_name: Optional[Any] = ..., authority_type: Optional[Any] = ..., group_name: Optional[Any] = ..., profile: Optional[Any] = ...) -> None: ...
    @property
    def ref(self): ...
    @ref.setter
