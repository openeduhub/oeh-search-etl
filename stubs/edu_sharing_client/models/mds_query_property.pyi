...
class MdsQueryProperty:
    swagger_types: Any = ...
    attribute_map: Any = ...
    discriminator: Any = ...
    def __init__(self, name: Optional[Any] = ..., label: Optional[Any] = ..., label_hint: Optional[Any] = ..., form_height: Optional[Any] = ..., form_length: Optional[Any] = ..., widget: Optional[Any] = ..., widget_title: Optional[Any] = ..., copy_from: Optional[Any] = ..., parameters: Optional[Any] = ..., values: Optional[Any] = ..., default_values: Optional[Any] = ..., multiple: bool = ..., place_holder: Optional[Any] = ..., style_name: Optional[Any] = ..., style_name_label: Optional[Any] = ..., type: Optional[Any] = ..., validators: Optional[Any] = ..., statement: Optional[Any] = ..., multiple_join: Optional[Any] = ..., toogle: bool = ..., init_by_get_param: Optional[Any] = ...) -> None: ...
    @property
    def name(self): ...
    @name.setter
    ...
    def multiple_join(self, multiple_join: Any) -> None: ...
    @property
    def toogle(self): ...
    @toogle.setter
    def toogle(self, toogle: Any) -> None: ...
    @property
    def init_by_get_param(self): ...
    @init_by_get_param.setter
    def init_by_get_param(self, init_by_get_param: Any) -> None: ...
    def to_dict(self): ...
    def to_str(self): ...
