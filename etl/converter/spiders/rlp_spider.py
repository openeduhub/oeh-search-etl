...
class RLPSpider(OAIBase):
  ...
  def shouldImport(self, response):
    ...
    rightsDescriptions = record.xpath('metadata/lom/rights/description/string//text()').get()
    if not rightsDescriptions:
      return False
    return (
      rightsDescriptions.startswith('https://creativecommons.org/licenses/pdm') or 
      rightsDescriptions.startswith('https://creativecommons.org/publicdomain/zero') or
      rightsDescriptions.startswith('https://creativecommons.org/licenses/by') or
      rightsDescriptions.startswith('https://creativecommons.org/licenses/by-sa')
    )
