...
class EduSharingBase(Spider, LomBase):
  ...
  def getProperty(self, name, response):
    return response.meta['item']['properties'][name] if name in response.meta['item']['properties'] else None
  ...
  def getLicense(self, response):
    ...
    license.add_value('internal', self.getProperty('ccm:commonlicense_key', response))
  ...
  def getValuespaces(self, response):
    ...
    valuespaces.add_value('sourceContentType', self.getProperty('ccm:sourceContentType', response))
    valuespaces.add_value('toolCategory', self.getProperty('ccm:toolCategory', response))
    return valuespaces
