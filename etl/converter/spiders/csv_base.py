...
class CSVBase(LomBase):
    ...
    def getLOMGeneral(self, response):
        ...
        general.replace_value('language', response.meta['row'][CSVBase.COLUMN_LANGUAGE]['text'])
        general.add_value('keyword', response.meta['row'][CSVBase.COLUMN_KEYWORD]['list'])
        general.add_value('description', response.meta['row'][CSVBase.COLUMN_DESCRIPTION]['text'])
        return general
    ...
    def getLOMTechnical(self, response):
        ...
        technical.add_value('location', response.meta['row'][CSVBase.COLUMN_URL]['text'])
