...
class STREAMV1Api(object):
    ...
    def add_entry(self, repository, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.add_entry(repository, body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.add_entry_with_http_info(repository, body, **kwargs)  # noqa: E501
        else:
            (data) = self.add_entry_with_http_info(repository, body, **kwargs)  # noqa: E501
            return data

    def add_entry_with_http_info(self, repository, body, **kwargs):  # noqa: E501
        """add a new stream object.  # noqa: E501

        will return the object and add the id to the object if creation succeeded  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_entry_with_http_info(repository, body, async_req=True)
        >>> result = thread.get()
    ...
    def search(self, repository, **kwargs):  # noqa: E501
        ...
        :param object body: map with property + value to search
    ...
    def search_with_http_info(self, repository, **kwargs):  # noqa: E501
        ...
        all_params = ['repository', 'status', 'query', 'max_items', 'skip_count', 'body', 'sort_properties', 'sort_ascending']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
