...
class SEARCHV1Api(object):
    ...
    def load_save_search_with_http_info(self, node_id, **kwargs):  # noqa: E501
        ...
        all_params = ['node_id', 'content_type', 'max_items', 'skip_count', 'sort_properties', 'sort_ascending', 'body', 'property_filter']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def save_search(self, repository, metadataset, query, name, body, **kwargs):  # noqa: E501
        """Save a search query.  # noqa: E501

        Save a search query.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_search(repository, metadataset, query, name, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.save_search_with_http_info(repository, metadataset, query, name, body, **kwargs)  # noqa: E501
        else:
            (data) = self.save_search_with_http_info(repository, metadataset, query, name, body, **kwargs)  # noqa: E501
            return data

    def save_search_with_http_info(self, repository, metadataset, query, name, body, **kwargs):  # noqa: E501
        """Save a search query.  # noqa: E501

        Save a search query.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_search_with_http_info(repository, metadataset, query, name, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['repository', 'metadataset', 'query', 'name', 'body', 'replace']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def search_v2(self, repository, metadataset, query, body, **kwargs):  # noqa: E501
        """Perform queries based on metadata sets V2.  # noqa: E501

        Perform queries based on metadata sets V2.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_v2(repository, metadataset, query, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.search_v2_with_http_info(repository, metadataset, query, body, **kwargs)  # noqa: E501
        else:
            (data) = self.search_v2_with_http_info(repository, metadataset, query, body, **kwargs)  # noqa: E501
            return data

    def search_v2_with_http_info(self, repository, metadataset, query, body, **kwargs):  # noqa: E501
        """Perform queries based on metadata sets V2.  # noqa: E501

        Perform queries based on metadata sets V2.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_v2_with_http_info(repository, metadataset, query, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['repository', 'metadataset', 'query', 'body', 'content_type', 'max_items', 'skip_count', 'sort_properties', 'sort_ascending', 'property_filter']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
