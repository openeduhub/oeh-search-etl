...
class BULKV1Api(object):
    ...
    def find(self, body, **kwargs):  # noqa: E501
        ...
        :param object body: properties that must match (with \"AND\" concatenated) (required)
        :return: NodeEntry
    ...
    def sync(self, group, match, type, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sync(group, match, type, body, async_req=True)
        >>> result = thread.get()
        ...
        :param object body: properties, they'll not get filtered via mds, so be careful what you add here (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.sync_with_http_info(group, match, type, body, **kwargs)  # noqa: E501
        else:
            (data) = self.sync_with_http_info(group, match, type, body, **kwargs)  # noqa: E501
            return data

    def sync_with_http_info(self, group, match, type, body, **kwargs):  # noqa: E501
        """Create or update a given node  # noqa: E501

        Depending on the given \"match\" properties either a new node will be created or the existing one will be updated  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sync_with_http_info(group, match, type, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['group', 'match', 'type', 'body', 'aspects']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
