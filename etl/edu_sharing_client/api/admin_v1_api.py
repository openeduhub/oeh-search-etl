...
class ADMINV1Api(object):
    ...
    def add_application_0(self, xml, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param file xml: XML file for app to register (required)
        :return: dict(str, object)
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def import_collections(self, xml, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param file xml: XML file to parse (or zip file containing exactly 1 xml file to parse) (required)
    ...
    def import_excel(self, parent, excel, **kwargs):  # noqa: E501
        """Import excel data  # noqa: E501

        Import excel data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_excel(parent, excel, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str parent: parent (required)
        :param file excel: Excel file to import (required)
        :return: ExcelResult
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.import_excel_with_http_info(parent, excel, **kwargs)  # noqa: E501
        else:
            (data) = self.import_excel_with_http_info(parent, excel, **kwargs)  # noqa: E501
            return data

    def import_excel_with_http_info(self, parent, excel, **kwargs):  # noqa: E501
        """Import excel data  # noqa: E501

        Import excel data.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_excel_with_http_info(parent, excel, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['parent', 'excel']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def import_oai_xml_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['record_handler_class_name', 'binary_handler_class_name', 'xml']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def start_job(self, job_class, body, **kwargs):  # noqa: E501
        """Start a Job.  # noqa: E501

        Start a Job.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_job(job_class, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str job_class: jobClass (required)
        :param object body: params (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.start_job_with_http_info(job_class, body, **kwargs)  # noqa: E501
        else:
            (data) = self.start_job_with_http_info(job_class, body, **kwargs)  # noqa: E501
            return data

    def start_job_with_http_info(self, job_class, body, **kwargs):  # noqa: E501
        """Start a Job.  # noqa: E501

        Start a Job.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_job_with_http_info(job_class, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['job_class', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def upload_temp(self, name, file, **kwargs):  # noqa: E501
        """Upload a file  # noqa: E501

        Upload a file to tomcat temp directory, to use it on the server (e.g. an update)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_temp(name, file, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.upload_temp_with_http_info(name, file, **kwargs)  # noqa: E501
        else:
            (data) = self.upload_temp_with_http_info(name, file, **kwargs)  # noqa: E501
            return data

    def upload_temp_with_http_info(self, name, file, **kwargs):  # noqa: E501
        """Upload a file  # noqa: E501

        Upload a file to tomcat temp directory, to use it on the server (e.g. an update)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_temp_with_http_info(name, file, async_req=True)
        >>> result = thread.get()
