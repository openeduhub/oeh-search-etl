...
class CONFIGV1Api(object):
    ...
    def set_dynamic_value(self, key, public, body, **kwargs):  # noqa: E501
        """Set a config entry (admin rights required)  # noqa: E501

        the body must be a json encapsulated string  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_dynamic_value(key, public, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.set_dynamic_value_with_http_info(key, public, body, **kwargs)  # noqa: E501
        else:
            (data) = self.set_dynamic_value_with_http_info(key, public, body, **kwargs)  # noqa: E501
            return data

    def set_dynamic_value_with_http_info(self, key, public, body, **kwargs):  # noqa: E501
        """Set a config entry (admin rights required)  # noqa: E501

        the body must be a json encapsulated string  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_dynamic_value_with_http_info(key, public, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['key', 'public', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
