...
class RATINGV1Api(object):
    ...
    def add_or_update_rating(self, repository, node, rating, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.add_or_update_rating(repository, node, rating, body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.add_or_update_rating_with_http_info(repository, node, rating, body, **kwargs)  # noqa: E501
        else:
            (data) = self.add_or_update_rating_with_http_info(repository, node, rating, body, **kwargs)  # noqa: E501
            return data

    def add_or_update_rating_with_http_info(self, repository, node, rating, body, **kwargs):  # noqa: E501
        """create or update a rating  # noqa: E501

        Adds the rating. If the current user already rated that element, the rating will be altered  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_or_update_rating_with_http_info(repository, node, rating, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['repository', 'node', 'rating', 'body']  # noqa: E501
