...
class JobDetail(object):
    ...
    def __init__(self, name=None, group=None, description=None, job_data_map=None, key=None, volatile=False, full_name=None, durable=False, stateful=False, job_listener_names=None):  # noqa: E501
